...
int main()
{
	...
	while (input != 5) {
		...
		printf("\n\n1. Add the information for the plane\n2.For displaying plane information\n");
		printf("3. Display all the plane informations stored\n");
		printf("4. List of the no of plane in the airport\n");
		printf("5. Exit");
